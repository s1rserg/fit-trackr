...
const TEMPLATES: Record<WorkoutType, RawTemplateItem[]> = {
  ...
  B: [
    ...
    {
      name: "Pull-Ups",
      description: "Full extension at bottom, chin over bar. Pull with back.",
      progressMetric: "reps",
      sets: 3,
      reps: "6–10",
      orderIndex: 2,
  ...
  C: [
    ...
    {
      name: "Leg Extensions",
      description: "Quads isolation. Controlled pause at peak extension.",
      progressMetric: "weight",
      sets: 3,
      reps: "8–12",
      orderIndex: 3,
    ...
    },
    {
      ...
      description: "Superset with Bicep Cable Curl. Keep elbows pinned.",
      progressMetric: "weight",
      sets: 3,
      reps: "10–15",
      orderIndex: 6,
    },
    {
      ...
      description: "Superset with Triceps Pressdown. Strict isolation.",
      progressMetric: "weight",
      sets: 3,
      reps: "10–15",
      orderIndex: 7,
    },
    {
      ...
      description: "Controlled abdominal crunch. Exhale on contraction.",
      progressMetric: "weight",
      sets: 3,
      reps: "10–20",
      orderIndex: 8,
